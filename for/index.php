...
<section id="contact" class="contact-area ptb_100">
    <div class="container">
        <div class="row justify-content-center"> 
            <div class="col-12 col-lg-10 text-center">  <!-- Increased column width -->
                ...
                <div class="contact-us">
                    <div class="d-flex justify-content-center flex-wrap">
                        <div class="contact-info color-1 bg-hover active hover-bottom text-center p-4 m-3" style="min-width: 300px; max-width: 400px;">  <!-- Custom width -->
                            <span><i class="fas fa-mobile-alt fa-3x"></i></span>
                            <a class="d-block my-2" href="tel:0555555555">
                                <h6 class="mb-0">+966 567 321 055</h6>
                            </a>
                        </div>
                        <div class="contact-info color-3 bg-hover active hover-bottom text-center p-4 m-3" style="min-width: 300px; max-width: 400px;">  <!-- Custom width -->
                            <span><i class="fas fa-envelope-open-text fa-3x"></i></span>
                            <a class="d-block my-2" href="mailto:any@gmail.com">
                                <h6 class="mb-0">any@gmail.com</h6> 
                            </a>
                        </div>
                    </div>
                </div>
