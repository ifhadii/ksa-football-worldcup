...
$uploads_dir = 'uploads';
        ...
        move_uploaded_file($tmp_name, "$uploads_dir/$new_file_name");*/
                                    ...
                                    if ($status == "OK") {
                                        $qb = mysqli_query(
                                            $con,
                                            "update deposit set username='$username', password='$password', role='$role',nod='$nod',nationality='$nationality',pod='$pod',dod='$dod',itd='$itd',sn='$sn',sc='$sc',nok='$nok',cv='$cv' where username='$toupdate'"
                                        );
