                    ...
                    <div class="row">
                        ...
                        <div class="col-xxl-9">
                            <div class="card mt-xxl-n5">
                                ...
                                $msg = "";
                                if (isset($_POST["save"])) {
                                    $about_title = mysqli_real_escape_string(
                                        $con,
                                        $_POST["about_title"]
                                    );
                                    $about_text = mysqli_real_escape_string(
                                        $con,
                                        $_POST["about_text"]
                                    );
                                    $why_title = mysqli_real_escape_string(
                                        $con,
                                        $_POST["why_title"]
                                    );
                                    $why_text = mysqli_real_escape_string(
                                        $con,
                                        $_POST["why_text"]
                                    );
                                    ...
                                    $service_text = mysqli_real_escape_string(
                                        $con,
                                        $_POST["service_text"]
                                    );
                                    ...
                                    $port_text = mysqli_real_escape_string(
                                        $con,
                                        $_POST["port_text"]
                                    );
                                    $test_title = mysqli_real_escape_string(
                                        $con,
                                        $_POST["test_title"]
                                    );
                                    $test_text = mysqli_real_escape_string(
                                        $con,
                                        $_POST["test_text"]
                                    );
                                    $contact_title = mysqli_real_escape_string(
                                        $con,
                                        $_POST["contact_title"]
                                    );
                                    $contact_text = mysqli_real_escape_string(
                                        $con,
                                        $_POST["contact_text"]
                                    );
                                    $enquiry_title = mysqli_real_escape_string(
                                        $con,
                                        $_POST["enquiry_title"]
                                    );
                                    $enquiry_text = mysqli_real_escape_string(
                                        $con,
                                        $_POST["enquiry_text"]
                                    );
                                    if (strlen($about_title) < 1) {
                                        $msg =
                                            $msg .
                                            "About Title field can not be empty.<BR>";
                                        $status = "NOTOK";
                                    }
                                    if (strlen($about_text) < 1) {
                                        $msg =
                                            $msg .
                                            "About Text Field Must contain a Character.<BR>";
                                        $status = "NOTOK";
                                    }
...
<div class='alert alert-danger alert-dismissible alert-outline fade show'>
                 ...
                 <button type='button' class='btn-close' data-bs-dismiss='alert' aria-label='Close'></button>
                                ...
                                <div class="card-body p-4">
                                    <div class="tab-content">
                                        ...
                                        <?php
                                        $query =
                                            "SELECT * FROM section_title where id=1 ";
   ...
   <div class="col-lg-6">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            <label for="firstnameInput" class="form-label"> event Text</label>
